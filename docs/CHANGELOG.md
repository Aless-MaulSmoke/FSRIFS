...
* **Bug Fix / Multi-GPU Support**: Resolved hardware lock restrictions. The pipeline, which previously ran exclusively on AMD graphics cards, now fully supports NVIDIA and Intel hardware (both dedicated and integrated chips) through the Vulkan API.
